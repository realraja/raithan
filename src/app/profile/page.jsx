...
import ChangeName from "@/components/user/ChangeNameDialog";
  ...
  return (
    <>
      <div className="flex max-sm:flex-col justify-between gap-20 max-sm:gap-3 max-sm:justify-start min-h-[90vh] px-10 max-sm:px-5 py-5">
        <div className="flex flex-col justify-center w-1/3 max-sm:w-full items-center gap-10">
          ...
          <label
            ...
            className="px-5 cursor-pointer py-2 text-xl bg-purple-600 hover:bg-purple-700 hover:scale-110 duration-500 rounded-md"
          >
            Change Image
          </label>

          {avatar !== user.avatar && <button onClick={handleUpdate} className="px-5 py-2 text-xl bg-purple-600 hover:bg-purple-700 hover:scale-110 duration-500 rounded-md">Update Now</button>}
        </div>
        <div className="flex flex-col items-center w-2/3 max-sm:w-full gap-5 px-5 pt-5">
          ...
          <div className="flex rounded-xl w-full bg-gray-800 hover:bg-gray-700 items-center py-2 px-8 gap-5 cursor-pointer ">
            ...
            <svg onClick={() => setIsDialogOpen2(true)}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <Link
            href={"#History"}
            className="flex rounded-xl w-full bg-gray-800 hover:bg-gray-700 items-center py-2 px-8 gap-5 cursor-pointer "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
      ...
      <CropperDialog
        ...
        isOpen={isDialogOpen}
      />
      <ChangeName confirmState={isDialogOpen2} setConfirmState={setIsDialogOpen2} name={name} setName={setName} runFunction={handleUpdate}  />
    </>
  );
};
...
const FeesHistory = () => {
  return (
    <div id="History" className="my-5 px-5 h-[50vh]">
      <p className="text-xl border-b pb-1">Fees History</p>

      <p className="my-5 text-2xl font-extralight font-sans text-center text-purple-600">
        Comming Soon
      </p>
    </div>
  );
