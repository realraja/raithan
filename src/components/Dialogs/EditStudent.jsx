...
const EditStudent = ({ confirmState, setConfirmState, studentData ,studentPassword}) => {
    ...
    console.log(studentData,studentPassword,courses)
  ...
  const handleAddStudent = async () => {
    ...
    try {
      const { data } = await axios.put('/api/admin/student', {
        name,
        phone,
        password,
        courses,
